...
import { browserCdp } from "../transport.mjs";
import { elementCenter } from "./observe.mjs";
import { resolveAndCall } from "./element-ops.mjs";
import { waitForSelector } from "./waits.mjs";
 ...
 * @returns {Promise<void>}
 */
export async function drag(points, options = {}) {
 ...
 * @returns {Promise<void>}
 */
export async function scrollIntoViewIfNeeded(selector) {
