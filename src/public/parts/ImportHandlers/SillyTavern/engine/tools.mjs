...
// 收口: escapeRegExp 原为逐字副本(字符类与权威逐字等价),改为 re-export 权威 scripts/escape.mjs(服务端 ImportHandler 引擎,与 messageTransform 同范式跨界 import 权威)
export { escapeRegExp } from '../../../../../scripts/escape.mjs'
