...
import info_dynamic from '../../../../../public/parts/serviceGenerators/AI/fallback/info.dynamic.json' with { type: 'json' }
import info from '../../../../../public/parts/serviceGenerators/AI/fallback/info.json' with { type: 'json' }
