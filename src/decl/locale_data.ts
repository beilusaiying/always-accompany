...
export type LocaleData = {
	...
	beiluConsole: {
		...
		path: {
			...
			remove: {
				removingBeilu: string
				beiluUninstallationComplete: string
				removingBeiluInstallationDir: string
				beiluInstallationDirRemoved: string
				removingBeiluFromPath: string
				removingProtocolHandler: string
				protocolHandlerRemoved: string
				removeProtocolHandlerFailed: string
				removingBeiluFromGitSafeDir: string
				removingInstalledSystemPackages: string
				uninstallingDeno: string
				removeDenoFailed: string
				removingBeiluPwshFromProfile: string
				beiluPwshRemovedFromProfile: string
				pwshProfileNotFound: string
				uninstallingBeiluPwsh: string
				uninstallBeiluPwshFailed: string
	...
	subbeilus: {
		...
		codeExecution: {
			title: string
			description: string
			selectSubbeiluLabel: string
			selectSubbeiluPlaceholder: string
			hostOption: string
			subbeiluOption: string
			scriptLabel: string
			executeButton: string
			executing: string
			noSubbeiluSelected: string
...
export type LocaleKeyParams = {
	...
	'beiluConsole.auth.accountLockedLog': { username: string | number }
	'beiluConsole.auth.logoutRefreshTokenProcessError': { error: string | number }
	'beiluConsole.auth.refreshTokenError': { error: string | number }
	'beiluConsole.auth.tokenVerifyError': { error: string | number }
	'beiluConsole.discordbot.botStarted': { botusername: string | number; charname: string | number }
	'beiluConsole.ipc.invokePartLog': { invokedata: string | number; partpath: string | number; username: string | number }
	'beiluConsole.ipc.parseResponseFailed': { error: string | number }
	'beiluConsole.ipc.processMessageError': { error: string | number }
	'beiluConsole.ipc.runPartLog': { args: string | number; partpath: string | number; username: string | number }
	'beiluConsole.ipc.sendCommandFailed': { error: string | number }
	'beiluConsole.ipc.socketError': { error: string | number }
	'beiluConsole.jobs.pausingJob': { partpath: string | number; uid: string | number; username: string | number }
	'beiluConsole.jobs.preloadingParts': { count: string | number }
	'beiluConsole.jobs.restartingJob': { partpath: string | number; uid: string | number; username: string | number }
	'beiluConsole.partManager.git.noUpstream': { currentBranch: string | number }
	'beiluConsole.partManager.git.updateFailed': { error: string | number }
	'beiluConsole.partManager.partInited': { partpath: string | number }
	'beiluConsole.partManager.partLoaded': { partpath: string | number }
	'beiluConsole.path.deno.patchUnsupportedArch': { arch: string | number }
	'beiluConsole.path.git.backupSavedTo': { path: string | number }
	'beiluConsole.path.git.noUpstreamBranch': { branch: string | number }
	'beiluConsole.path.install.packageFailed': { package: string | number }
	'beiluConsole.path.protocol.registerFailed': { message: string | number }
	'beiluConsole.path.remove.moduleRemoved': { module: string | number }
	'beiluConsole.path.remove.removeBackgroundRunnerFailed': { message: string | number }
	'beiluConsole.path.remove.removeDenoFailed': { message: string | number }
	'beiluConsole.path.remove.removeModuleFailed': { message: string | number; module: string | number }
	'beiluConsole.path.remove.removeProtocolHandlerFailed': { message: string | number }
	'beiluConsole.path.remove.uninstallBeiluPwshFailed': { message: string | number }
	'beiluConsole.path.shortcut.desktopShortcutCreated': { path: string | number }
	'beiluConsole.path.shortcut.shortcutNotSupported': { os: string | number }
	'beiluConsole.path.shortcut.startMenuShortcutCreated': { path: string | number }
	'beiluConsole.route.setLanguagePreference': { preferredLanguages: string | number; username: string | number }
	'beiluConsole.server.localUrl': { url: string | number }
	'beiluConsole.server.mdns.bonjourFailed': { error: string | number }
	'beiluConsole.server.mdns.failed': { error: string | number }
	'beiluConsole.server.showUrl.http': { url: string | number }
	'beiluConsole.server.showUrl.https': { url: string | number }
	'beiluConsole.telegrambot.botStarted': { botusername: string | number; charname: string | number }
	'beiluConsole.tray.createTrayFailed': { error: string | number }
	'beiluConsole.tray.readIconFailed': { error: string | number }
	'beiluConsole.verification.codeGeneratedLog': { code: string | number }
	'beiluConsole.verification.codeNotifyBody': { code: string | number }
	'beiluConsole.web.frontendFilesChanged': { path: string | number }
	'beiluConsole.web.requestReceived': { method: string | number; url: string | number }
	...
	'subbeilus.codeExecution.executionFailed': { message: string | number }
	'subbeilus.codeExecution.hostOption': { id: string | number }
	'subbeilus.codeExecution.subbeiluOption': { deviceId: string | number; id: string | number }
	'subbeilus.connectedSubbeilus.descriptionSaveFailed': { message: string | number }
	'subbeilus.errors.generalError': { message: string | number }
	'subbeilus.errors.loadConnectionCodeFailed': { message: string | number }
	'subbeilus.errors.regenerateConnectionCodeFailed': { message: string | number }
