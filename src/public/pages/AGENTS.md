...
**See also**: [beilu Architecture & AI Agent Prompting Guide](../../../AGENTS.md) (root); [Shell Architecture & Creation Guide](../parts/shells/AGENTS.md) for Shell-specific frontend/backend patterns.
...
- **Purpose**: Functions for fetching and managing beilu "parts" (e.g.,
  characters, worlds).
...
- `createPartpathPicker({ dropdown, breadcrumbList, menu, onChange, ... })`:
  Initializes a breadcrumb-style navigator for selecting beilu "parts" (e.g.,
...
### 6.1. POW Captcha (`POWcaptcha.mjs`)
