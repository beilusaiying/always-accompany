...
(function() {
	...
	/* T12：ST 兼容 shim 默认值。供 iframe 内第三方 ST 脚本读 st.maxContext 时有非零合理值；
	   beilu 真实上下文上限走子模式/预设的 openai_max_context（0=用预设值，见 subModePanel.mjs），
	   注入模板为静态字符串拿不到该运行时值，故此处保留兼容默认（无对应可注入真源）。 */
