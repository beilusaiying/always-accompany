...
The background P2 trigger has been stopped. The current manual-button path has a known issue: it returns early when it sees manual_button. Do not present P2 as a stable automatic summarizer.
